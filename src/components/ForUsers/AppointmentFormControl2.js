...
import {appointmentServicerandom} from "../../Services/User/appointmentService";
import { useNavigate } from "react-router-dom";
import PopupNotification from "../forAll/PopupNotification";

function AppointmentFormControl2() {
...
const isFormValid = () => {
  ...
  async function handelsubmit() {
    ...
    if (isFormValid()) {
      try {
        const response = await appointmentServicerandom(data, userId);
...
export default AppointmentFormControl2;
