  ...
  return (
...

    {
      doctorList.map((value,index)=>(
        <div key={index} className="border shadow-xl w-[360px] my-5 text-center">
       <Link to='/doctordetailuser'> <img className="w-full h-[260px]" src={img} alt="img" />
        <div>
          <h1 className="mt-2">Dr Sameer Thapa</h1>
